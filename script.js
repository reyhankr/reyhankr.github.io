function initengahan(){
  ...
  function tombol(){wallpaper.style="transform: scale(1);";Tombol.style="opacity:1;transform: scale(1);";if(fungsi==2){By.innerHTML="&#128140; Lanjut pencet ini yaa sayangku"}}
  ...
  function aktipesan4(){
    wallpaper.style="transform: scale(1.5);";kalimat.innerHTML=pesan4.innerHTML + "Cintaku" + "❤️";kalimat.style="transform:scale(1.2)";setTimeout(aktipesan5,1000);
  }
  ...
  async function pertanyaan(){var { isConfirmed: prtanya } = await swals.fire({title: "Ayang" + ' ' + tanya, text: '' + opstanya, imageUrl: '' + fotostiker6.src, showCancelButton: true, confirmButtonText: '' + tompositif, cancelButtonText: '' + tomnegatif,});
    if(prtanya){
